...
Say ''
Say 'obsidian:// リンクを使っている場合の注意:'
Say '  2つ目のObsidianを起動すると、obsidian:// リンクの飛び先が'
Say '  そちらへ移り、しかも設定フォルダの指定が抜けた形で登録されます。'
Say '  リンクを踏んでも「タスクバーが点滅するだけで窓が出てこない」'
Say '  状態になったら、同じフォルダの fix-links.bat を実行してください。'
Say ''
